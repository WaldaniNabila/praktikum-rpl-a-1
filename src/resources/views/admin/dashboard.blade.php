...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Admin — JobHub</title>
...
<body class="bg-gray-50">
    <div class="max-w-7xl mx-auto px-6 py-10">
        ...
        <p class="text-gray-500 mt-1">Selamat datang di panel admin JOBHUB.</p>
        ...
        <div class="mt-8 grid grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                <div class="text-sm text-gray-500">Lowongan Pending</div>
                <div class="text-3xl font-semibold text-amber-600 mt-1">0</div>
            </div>
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                <div class="text-sm text-gray-500">Perusahaan Pending</div>
