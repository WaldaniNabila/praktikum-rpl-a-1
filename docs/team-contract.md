...
* **Izanahda Nurkhasna**: **Quality Assurance (QA) & Frontend**
...
* **Intan Trinanda**: **Documentation & Technical Writer**
...
* **Hari**: [Misal: Setiap hari Kamis]
* **Waktu**: [Misal: 19.00 WIB - Selesai]
* **Platform**: [Misal: Google Meet / Discord / Zoom/ Offline]
* **Agenda**: Update progress mingguan, pembagian task baru, penyelesaian kendala teknis, dan Evaluasi.
...
---
*Kontrak ini disepakati oleh seluruh anggota tim pada tanggal [5 April 2026].*
